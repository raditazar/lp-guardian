    ...
    <section className="p-5 rounded-lg border border-slate-700 bg-slate-900/50">
        ...
        >
          ...
          <div className="text-[11px] leading-relaxed text-orange-200">
            ...
            <p className="mt-0.5 text-orange-100/90">
              {/* TODO(arch): 0G Compute TEE label retained — revise after backend redesign for Robinhood Chain */}
      ...
      {!stub && (
        <p className="mt-3 text-[10px] text-slate-500">
          {/* TODO(arch): 0G Compute label retained — revise after backend redesign for Robinhood Chain */}
